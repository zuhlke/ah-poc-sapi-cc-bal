...
public class CustomBehaviourPolicyHeaders implements BehaviourPolicyHeaders {
    ...
    public CustomBehaviourPolicyHeaders(Map<String, String> headers) throws BadlyFormattedSapiPolicyHeaderException {
        try {
    ...
    @Override
    public void configure(SapiStubBehaviourPolicy behaviourPolicy) {
        behaviourPolicy.setFailureRate(failureRate);
        behaviourPolicy.setPerRequestDelayRange(minDelay, maxDelay);
    }
}
